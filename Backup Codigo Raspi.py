...
def interfaz():
    ...
    resize_logo_N611=logo_N611.resize((160,160))
    ...
    text_segundos.place(relx=0.65,rely=0.7,relwidth=0.1,relheight=0.15)
    text_mes_pasado.place(relx=0.45,rely=0.2,relwidth=0.2,relheight=0.3)
    text_mes_actual.place(relx=0.45,rely=0.55,relwidth=0.2,relheight=0.3)
    ...
    Tiempo_servicio.place(relx=0.15,rely=0.5,relwidth=0.67,relheight=0.2)
    ...
    mes_pasado.place(relx=0.25,rely=0.25,relwidth=0.2,relheight=0.2)
    mes_actual.place(relx=0.25,rely=0.6,relwidth=0.2,relheight=0.2)
    ...
    unidad_horas.place(relx=0.21,rely=0.7,relwidth=0.1,relheight=0.15)
    unidad_minutos.place(relx=0.46,rely=0.7,relwidth=0.15,relheight=0.15)
    unidad_segundos.place(relx=0.75,rely=0.7,relwidth=0.2,relheight=0.15)
    unidad_mes_pasado.place(relx=0.65,rely=0.2,relwidth=0.15,relheight=0.3)
    unidad_mes_actual.place(relx=0.65,rely=0.55,relwidth=0.15,relheight=0.3)
