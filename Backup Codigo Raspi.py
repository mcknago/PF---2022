...
def interfaz():
    ...
    mes_pasado.place(relx=0.37,rely=0.25,relwidth=0.3,relheight=0.2)
    mes_actual.place(relx=0.37,rely=0.6,relwidth=0.3,relheight=0.2)
    text_mes_pasado.place(relx=0.7,rely=0.2,relwidth=0.2,relheight=0.3)
    text_mes_actual.place(relx=0.7,rely=0.55,relwidth=0.2,relheight=0.3)
    factura.place(relx=0.05,rely=0.2,relwidth=0.2,relheight=0.2)
    con_sistema.place(relx=0.35,rely=0.25,relwidth=0.25,relheight=0.2)
    sin_sistema.place(relx=0.35,rely=0.6,relwidth=0.25,relheight=0.2)
