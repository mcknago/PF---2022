...
def Controlador():
    ...
    def ask_ac():
        global servicio, tiempo_sin_servicio_controler, inicio_apagon, fin_apagon, Error_red
        intento=True
        numero_intento=1
    ...
    def calculate_consume():
        ...
        global mes_actual_controler,sin_sistema_controler,con_sistema_controler
